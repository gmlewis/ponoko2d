...
func New(w io.Writer) *SVG { return &SVG{Writer: w, Decimals: 2, endString: "</svg>"} }
...
// StartviewUnit begins the SVG document with the specified width, height, and viewbox
...
func (svg *SVG) End() { svg.println(svg.endString) }
